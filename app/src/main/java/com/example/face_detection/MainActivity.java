...
public class MainActivity extends CameraActivity implements CvCameraViewListener2 {
    ...
    public static final String MODEL_XML = "ssdlite_mobilenet_v2_fp16.xml";
    public static final String MODEL_BIN = "ssdlite_mobilenet_v2_fp16.bin";
    ...
    public static BlockingQueue<float[]> detectionOutput = new LinkedBlockingQueue<float[]>(); // 不能添加null元素
    ...
    private void processInferRequets(WaitMode wait) {
        ...
        while (!startedRequestsIds.isEmpty()) {
            ...
            if (inferRequest.Wait(wait) != StatusCode.OK) return; // STATUS_ONLY => StatusCode OK
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Runnable infer = () -> {
            try {
                // Thread.sleep(5000); // Wait for several seconds
...
//                        skipFrame = !skipFrame;
    ...
    public Mat onCameraFrame(CvCameraViewFrame inputFrame) {
        ...
        try {
            ...
            Imgproc.resize(currentFrame, currentFrame, new Size(352, 288));
